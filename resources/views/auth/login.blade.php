        ...
        <div class="hidden lg:flex relative flex-col justify-between bg-ink text-paper px-14 py-12 overflow-hidden">
            ...
            <div class="relative z-10">
                <a href="feed.html" class="inline-flex items-center gap-2">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
                        ...
                        <line x1="6" y1="15" x2="24" y2="6" stroke="#5B6472"
                            stroke-width="1.5" />
                        <line x1="6" y1="15" x2="24" y2="24" stroke="#5B6472"
                            stroke-width="1.5" />
                    </svg>
            ...
            <div class="relative z-10 max-w-md">
                <p class="font-display text-[2.6rem] leading-[1.15] font-medium">
                    Pick up right where<br />your network left off.
                </p>
                <p class="mt-5 text-paper/60 text-base leading-relaxed">
                    New posts, comments, and conversations from the people you follow are waiting.
                </p>
            </div>
        ...
        <div class="flex flex-col items-center justify-center px-6 sm:px-10 py-14">
            <div class="w-full max-w-sm">
                ...
                <form class="mt-8 space-y-4" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <a href="#" class="text-xs text-slate hover:text-ember transition">Forgot
                                password?</a>
                        </div>
                    ...
                    <label class="flex items-center gap-2.5 pt-1">
                        <input type="checkbox" class="w-4 h-4 rounded border-line text-ember focus:ring-ember/40">
                        <span class="text-sm text-slate">Keep me signed in</span>
                    </label>

                    <button type="submit"
                        class="w-full bg-ember text-white font-medium text-sm rounded-lg py-[10px] mt-2 hover:bg-ember/90 active:scale-[0.99] transition shadow-sm">
                        Sign in
                    </button>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button
                        class="flex items-center justify-center gap-2 border border-line rounded-lg py-2.5 text-sm font-medium hover:bg-ink/[0.03] transition">
                ...
                <p class="mt-8 text-center text-sm text-slate">
                    New to LinkUp? <a href="{{ route('show.register') }}"
                        class="text-ink font-medium hover:text-ember transition">Create an account</a>
                </p>
            </div>
        </div>
