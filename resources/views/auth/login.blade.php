...
<body class="bg-[#f4f2ee] text-[rgba(0,0,0,0.9)] font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col items-center px-4 py-10">
        ...
        <div class="w-full max-w-[420px] bg-white border border-[rgba(0,0,0,0.08)] rounded-lg shadow-sm p-8">
            ...
            <h1 class="text-2xl font-semibold tracking-tight text-center">Welcome back</h1>
            <p class="mt-1.5 text-sm text-[rgba(0,0,0,0.6)] text-center">Sign in to continue to your feed.</p>
            ...
            <form class="mt-6 space-y-4" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="password" class="block text-xs font-semibold text-[rgba(0,0,0,0.6)]">Password</label>
                        <a href="#" class="text-xs text-[#0a66c2] hover:text-[#004182] transition">Forgot
                            password?</a>
                    </div>
                ...
                <label class="flex items-center gap-2.5 pt-1">
                    <input type="checkbox"
                        class="w-4 h-4 rounded border-[rgba(0,0,0,0.4)] text-[#0a66c2] focus:ring-[#0a66c2]/30">
                    <span class="text-sm text-[rgba(0,0,0,0.6)]">Keep me signed in</span>
                </label>
            ...
            <p class="mt-8 text-center text-sm text-[rgba(0,0,0,0.6)]">
                ...
                <a href="{{ route('show.register') }}"
                    class="text-[#0a66c2] font-semibold hover:text-[#004182] transition">Create an account</a>
            </p>
        </div>
