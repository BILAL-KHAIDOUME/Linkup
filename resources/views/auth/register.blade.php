        ...
        <div class="flex flex-col items-center justify-center px-6 sm:px-10 py-14">
            <div class="w-full max-w-sm">
                ...
                <form class="mt-8 space-y-4" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="name" name="name" placeholder="Bilal" 
                                value="{{ old('name') }}"
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-ink mb-1.5">Confirm
                            Password</label>
                    ...
                    <label class="flex items-start gap-2.5 pt-1">
                        <input type="checkbox"
                            class="mt-0.5 w-4 h-4 rounded border-line text-ember focus:ring-ember/40">
                        <span class="text-xs text-slate leading-relaxed">I agree to LinkUp's <a href="#"
                                class="text-ink underline hover:text-ember">Terms of Service</a> and <a href="#"
                                class="text-ink underline hover:text-ember">Privacy Policy</a>.</span>
                    </label>
                ...
                <p class="mt-8 text-center text-sm text-slate">
                    Already on LinkUp? <a href="{{ route('show.login') }}"
                        class="text-ink font-medium hover:text-ember transition">Sign in</a>
                </p>
            </div>
        </div>
