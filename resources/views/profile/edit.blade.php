        ...
        <div class="bg-white border border-[rgba(0,0,0,0.08)] rounded-lg overflow-hidden shadow-sm sticky top-20">
            ...
            <div class="px-4 pb-4 text-center -mt-8">
                <a href="{{ route('profileEdit') }}">
                    ...
                    <p class="text-xs text-[rgba(0,0,0,0.6)] leading-snug mt-1 px-2">
                        {{ Auth::user()->headline ?? 'No headline set' }}</p>
        ...
        <div class="bg-white border border-[rgba(0,0,0,0.08)] rounded-lg p-6 shadow-sm">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="name" class="block text-xs font-semibold text-[rgba(0,0,0,0.6)] mb-1.5">Full Name
                            *</label>
                    ...
                    <div>
                        <label for="company"
                            class="block text-xs font-semibold text-[rgba(0,0,0,0.6)] mb-1.5">company</label>
                ...
                <!-- Headline Input -->
                <div>
                    <label for="headline" class="block text-xs font-semibold text-[rgba(0,0,0,0.6)] mb-1.5">Headline
                        *</label>
                    ...
                    <p class="text-[11px] text-[rgba(0,0,0,0.5)] mt-1">Provide a brief catchphrase describing your current
                        professional role or expertise.</p>
                </div>
                ...
                <div>
                    ...
                    <div
                        class="flex items-center gap-4 p-3 border border-dashed border-[rgba(0,0,0,0.2)] rounded-lg bg-[rgba(0,0,0,0.01)]">
                        ...
                        <div class="flex-1">
                            <input type="file" name="profile_photo" id="profile_photo"
                                class="text-xs text-[rgba(0,0,0,0.6)] file:mr-3 file:py-1.5 file:px-3 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-[rgba(10,102,194,0.08)] file:text-[#0a66c2] hover:file:bg-[rgba(10,102,194,0.15)] file:cursor-pointer transition">
